...
export class TerminalCursor {
    ...
    init() {
        // Non inizializzare il cursore terminale su dispositivi mobili
        ...
        requestAnimationFrame(() => {
            this.updateSuppressionState(); // check suppression again
    ...
    updateSuppressionState() {
        ...
        if (!body) return;
        const shouldSuppress = body.classList.contains('js-pacman-cursor-active') || 
                            body.classList.contains('js-glitch-cursor-active') || 
                            body.classList.contains('js-simple-cursor-active') ||
                            body.classList.contains('custom-cursor-active');
