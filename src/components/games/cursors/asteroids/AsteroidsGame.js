...
import { debounce } from '../pacman/utils.js';
...
export class AsteroidsGame {
    ...
    this.globalAlpha = 0;
        ...
        // Debounce the boundary update function to avoid performance issues on scroll/resize
        this.debouncedSetBoundaries = debounce(() => this.setBounceBoundaries('.interactive-bounce'), 100);
    }
    ...
    start() {
        ...
        this.handleResize();
        this.setBounceBoundaries('.interactive-bounce'); // Set initial boundaries
        this.reset();
        this.gameLoop();
    }
    ...
    addEventListeners() {
        ...
        EventBus.on('global:scroll', this.handleScroll);
    ...
    removeEventListeners() {
        ...
        EventBus.off('global:scroll', this.handleScroll);
