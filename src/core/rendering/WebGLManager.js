// src/core/rendering/WebGLManager.js
...
// Sale da 'rendering' a 'components', poi in 'effects'
import { VhsPageTransitionShader } from '../../components/effects/VhsTransitionShader.js';
...
export class WebGLManager {
    ...
    this.composer.addPass(new RenderPass(this.scene, this.camera));
        ...
        EventBus.on('global:resize', this.onResize);
    }


    destroy() {
        EventBus.off('global:resize', this.onResize);
    }
